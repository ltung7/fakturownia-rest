...
export type InvoiceKind = 'vat' | 'proforma' | 'receipt' | 'advance' | 'final' | 'correction' | 'vat_mp' | 'kp' | 'kw' | 'estimate';
export type InvoiceStatus = 'issued' | 'sent' | 'paid' | 'partial' | 'rejected';
export type PaymentType = 'transfer' | 'card' | 'cash' | 'barter' | 'cheque' | 'off' | 'online' | "";
